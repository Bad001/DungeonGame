...
class Game {
    ...
    enterLevel() { // Presets method
        switch (this.currentLevelIndex) {
            case 0:
                this.currentLevelDungeon = dungeon[0];
                ...
                break;
            case 1:
                this.currentLevelDungeon = dungeon[1];
                ...
                break;
            case 2:
                this.currentLevelDungeon = dungeon[2];
                this.player.move = [4,4];
                this.currentLevelDungeon[4][4] = this.player;
                ...
                break;
            case 3:
                this.currentLevelDungeon = dungeon[3];
                this.player.move = [4,4];
                this.currentLevelDungeon[4][4] = this.player;
            ...
            case 4:
                ...
                break;
            case 5:
                this.currentLevelDungeon = dungeon[4];
                this.player.move = [4,4];
                this.currentLevelDungeon[4][4] = this.player;
                ...
                break;
            case 6:
                this.currentLevelDungeon = dungeon[5];
                this.player.move = [4,0];
                this.currentLevelDungeon[4][0] = this.player;
            ...
            case 10:
                ...
                break;
            case 11:
                this.currentLevelDungeon = dungeon[6];
                this.player.move = [4,4];
                this.currentLevelDungeon[4][4] = this.player;
        ...
        this.socket.emit('presets', this.currentLevelDungeon);
    }
